...
import { ReservationContainer } from "@infrastructure/DIContainers/reservation.container";
...
export class ReservationController {
  ...
  public async getAllReservationByIDAsync(req: any, res: any) {
    try {
      const reservation = await this.reservationService.getAllReservationByID(
        req.params.id
      );
